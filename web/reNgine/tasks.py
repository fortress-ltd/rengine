...
def parse_nuclei_result(line):
	...
	return {
		...
		'epss_score': line['info'].get('classification', {}).get('epss-score', []) or [],
		'epss_percentile': line['info'].get('classification', {}).get('epss-percentile', []) or [],
		'cpe': line['info'].get('classification', {}).get('cpe', []) or [],
		'remediation': line['info'].get('remediation', []) or [],
		'impact': line['info'].get('impact', []) or [],
